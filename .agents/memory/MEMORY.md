...
- [Florence Transformers compatibility](florence-transformers-compat.md) — Florence-2 remote code lacks SDPA capability metadata; force eager because Transformers may auto-select SDPA.
