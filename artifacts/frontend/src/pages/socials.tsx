...
import { ChannelAnalysis } from "@/components/social-channel-analysis";
        ...
        <div className="relative max-w-7xl mx-auto px-8 pt-16 pb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-3 text-muted-foreground text-lg font-medium" data-testid="text-hero-stats">
              <strong className="text-foreground tabular-nums">{fmt(animFollowers)}</strong> total audience · <strong className="text-foreground tabular-nums">{fmt(animViews)}</strong> total views
            </p>
